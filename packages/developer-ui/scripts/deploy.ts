...
const localRegistryAddress = "0x8f0483125FCb9aaAEFA929D8E9d7b9C8B9Fb90F"
...
async function main() {
  ...
  const messageContract = new Contract(entries1['MessageTransfer'].messageAddress, artifacts.TransferDefinition.abi, owner)
