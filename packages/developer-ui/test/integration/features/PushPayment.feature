Feature: PushPayments
	...
	Scenario: PushPaymentUserA can create push payment and send funds to PushPaymentUserB
		...
		Given PushPaymentUserA authorize gateway url of 'http://localhost:5010'
		When PushPaymentUserA initiate push payment with public identifier of 'vector7cj246GhtigBXCVJ2ypwHHU9KcnPqzYJ7eTwwet4Fi8S8VPH17', Required Stake of '1', token selector of 'ETH', amount of '1', gateway url of 'http://localhost:5010' and click submit payment
