...
contract HypernetlabsVoting is IForwarder, IACLOracle, TokenManagerHook, AragonApp {
    ...
    string private constant ERROR_VOTE_ID_ZERO = "HYPERNETLABS_VOTING_VOTE_ID_ZERO";
    string private constant ERROR_NO_VOTE = "HYPERNETLABS_VOTING_NO_VOTE";
    string private constant ERROR_INIT_PCTS = "HYPERNETLABS_VOTING_INIT_PCTS";
    string private constant ERROR_CHANGE_SUPPORT_PCTS = "HYPERNETLABS_VOTING_CHANGE_SUPPORT_PCTS";
    string private constant ERROR_CHANGE_QUORUM_PCTS = "HYPERNETLABS_VOTING_CHANGE_QUORUM_PCTS";
    string private constant ERROR_INIT_SUPPORT_TOO_BIG = "HYPERNETLABS_VOTING_INIT_SUPPORT_TOO_BIG";
    string private constant ERROR_CHANGE_SUPPORT_TOO_BIG = "HYPERNETLABS_VOTING_CHANGE_SUPP_TOO_BIG";
    string private constant ERROR_CAN_NOT_VOTE = "HYPERNETLABS_VOTING_CAN_NOT_VOTE";
    string private constant ERROR_CAN_NOT_EXECUTE = "HYPERNETLABS_VOTING_CAN_NOT_EXECUTE";
    string private constant ERROR_CAN_NOT_FORWARD = "HYPERNETLABS_VOTING_CAN_NOT_FORWARD";
    string private constant ERROR_ORACLE_SENDER_MISSING = "HYPERNETLABS_VOTING_ORACLE_SENDER_MISSING";
    string private constant ERROR_ORACLE_SENDER_TOO_BIG = "HYPERNETLABS_VOTING_ORACLE_SENDER_TOO_BIG";
    string private constant ERROR_ORACLE_SENDER_ZERO = "HYPERNETLABS_VOTING_ORACLE_SENDER_ZERO";
