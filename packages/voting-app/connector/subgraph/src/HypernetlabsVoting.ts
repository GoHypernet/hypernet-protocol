...
import {
  ...
  HypernetlabsVoting as HypernetlabsVotingContract
} from '../generated/templates/HypernetlabsVoting/HypernetlabsVoting'
import {
  Vote as VoteEntity,
  Cast as CastEntity
...
function _populateVoteDataFromContract(vote: VoteEntity, appAddress: Address, voteNum: BigInt): void {
  let hypernetlabsVoting = HypernetlabsVotingContract.bind(appAddress)

  let voteData = hypernetlabsVoting.getVote(voteNum)
  ...
  vote.orgAddress = hypernetlabsVoting.kernel()
