        ...
        <div key={index}>
          ...
          {link.pushPayments.map((pushPayment, index) => (
            <div key={index}>
              ...
              <p>
                <b>State: </b>{" "}
                {new PaymentStatusParams(pushPayment.state).state}
              </p>
              <p>
              ...
              <p>
                <b>Required Stake: </b>{" "}
                {utils.formatUnits(pushPayment.requiredStake, "wei")}
              </p>
              <p>
                <b>Amount Staked: </b>{" "}
                {utils.formatUnits(pushPayment.amountStaked, "wei")}
              </p>
              <p>
                <b>Expiration Date: </b>{" "}
                {moment.unix(pushPayment.expirationDate).format()}
              </p>
              <p>
              ...
              <p>
                <b>Collateral Recovered: </b>{" "}
                {utils.formatUnits(pushPayment.collateralRecovered, "wei")}
              </p>
              <p>
              ...
              <p>
                <b>Payment Amount: </b>{" "}
                {utils.formatUnits(pushPayment.paymentAmount, "wei")}
              </p>
            </div>
          ))}
          <br />
