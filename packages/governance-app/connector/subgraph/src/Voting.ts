...
import { Vote as VoteEntity, Cast as CastEntity } from "../generated/schema";
...
function _populateVoteDataFromContract(
  vote: VoteEntity,
  appAddress: Address,
  voteNum: BigInt,
): void {
...
function _populateVoteDataFromEvent(
  vote: VoteEntity,
...
function _populateCastDataFromEvent(
  cast: CastEntity,
  event: CastVoteEvent,
): void {
