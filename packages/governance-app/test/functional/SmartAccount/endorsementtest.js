...
contract('SmartAccount', function(accounts) {
    ...
    describe("Endorsement tests", function() {
        ...
        it("will add an attribute for testing purposes", function() {
            return smartAccount.addAttribute(attributeHash1, {from: owner})
            .then(function(response) {
        ...
        it("will confirm that the owner's attribute was added successfully", function() {
            return smartAccount.attributes.call(attributeHash1)
            .then(function(response) {
        ...
        it("will add an endorsement from an endorser", function() {
            return smartAccount.addEndorsement(attributeHash1, endorsementHash, {from: endorser})
            .then(function(response) {
        ...
        it("will accept the endorsement as the owner", function() {
            return smartAccount.acceptEndorsement(attributeHash1, endorsementHash, {from: owner})
            .then(function(response) {
        ...
        it("will confirm that the endorsement has been added successfully", function() {
            return smartAccount.checkEndorsementExists.call(attributeHash1, endorsementHash, {from: endorser})
            .then(function(response) {
        ...
        it("will attempt to remove an endorsement as the owner (fail)", function() {
            return smartAccount.removeEndorsement.call(attributeHash1, endorsementHash, {from: owner})
        ...
        it("will attempt to remove an endorsement as a third party (fail)", function() {
            return smartAccount.removeEndorsement.call(attributeHash1, endorsementHash, {from: thirdparty})
            .catch(function(error) {
                assert.isOk(error, "Expected error has not been caught");
            });
        });
        ...
        it("will remove the endorsement as the endorser", function() {
            return smartAccount.removeEndorsement(attributeHash1, endorsementHash, {from: endorser})
            .then(function(response) {
        ...
        it("will confirm that an endorsement is invalid if an attribute is removed", function() {
            return smartAccount.addAttribute(attributeHash2, {from: owner})
            .then(function(response) {
                assert.isOk(response, "Attribute was not added successfully");
                return smartAccount.addEndorsement(attributeHash2, endorsementHash, {from: endorser})
            }).then(function(response) {
                ...
                return smartAccount.checkEndorsementExists.call(attributeHash2, endorsementHash, {from: endorser})
            }).then(function(response) {
        ...
        it("will make sure that an endorser can delete an endorsement after an attribute has been removed", function() {
            return smartAccount.addAttribute(web3.sha3("testhash"), {from: owner})
            .then(function(response) {
                assert.isOk(response, "Attribute was not added successfully");
                return smartAccount.addEndorsement(web3.sha3("testhash"), web3.sha3("testendorsement"), {from: endorser})
            }).then(function(response) {
                assert.isOk(response, "Endorsement was not added successfully");
                return smartAccount.removeAttribute(web3.sha3("testhash"), {from: owner})
            }).then(function(response) {
                assert.isOk(response, "Attribute was not removed successfully");
                return smartAccount.removeEndorsement(web3.sha3("testhash"), web3.sha3("testendorsement"), {from: endorser})
            }).then(function(response) {
        ...
        it("will make sure that an endorser cannot add an endorsement to a non-existent attribute", function() {
            return smartAccount.addEndorsement(web3.sha3("non-existent attribute"), web3.sha3("new endorsement"), {from: endorser})
            .catch(function(error) {
        ...
        it("will add an endorsement from the endorser for testing purposes", function() {
            return smartAccount.addEndorsement(attributeHash1, endorsementHash2, {from: endorser})
            .then(function(response) {
                var addEndorsementStatus = response.logs[0].args.status;
                assert.equal(4, addEndorsementStatus, "Transaction returned unexpected status");
        ...
        it("will remove the endorsement as the owner", function() {
            return smartAccount.removeEndorsement(attributeHash1, endorsementHash2, {from: owner})
            .then(function(response) {
                var removeEndorsementStatus = response.logs[0].args.status;
                assert.equal(3, removeEndorsementStatus, "Transaction returned unexpected status");
