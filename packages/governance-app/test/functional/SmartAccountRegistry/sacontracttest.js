/**
 * The purpose of this test contract is to test the functions in SmartAccountRegistry.sol.
 */

var SmartAccountRegistry = artifacts.require("SmartAccountRegistry");

contract("SmartAccountRegistry", function (accounts) {
  var registry,
    contractRegistry1,
    contractRegistry2,
    contracthash1,
  ...
  before(
    "Setup the Smart Account registry and hydrate the required variables",
    function (done) {
      contractRegistry1 = accounts[0];
      contractRegistry2 = accounts[1];

      SmartAccountRegistry.new({ from: contractRegistry1 }).then(function (
        response,
      ) {
        registry = response;
        done();
      ...
      return registry, contractRegistry1, contractRegistry2;
    },
  );

  describe("SmartAccountRegistry tests", function () {
    it("will submit a contract into the registry", function () {
      return registry
        .submitContract(contracthash1, { from: contractRegistry1 })
    ...
    it("will prove that the registry owner can approve a contract", function () {
      return registry
        .approveContract(contracthash1, { from: contractRegistry1 })
        .then(function (response) {
    ...
    it("will prove that a non-owner cannot approve a contract", function () {
      return registry
        .approveContract(contracthash1, { from: contractRegistry2 })
    ...
    it("will prove that the registry owner can reject a contract", function () {
      return registry
        .rejectContract(contracthash1, { from: contractRegistry1 })
        .then(function (response) {
    ...
    it("will prove that a non-owner cannot reject a contract", function () {
      return registry
        .rejectContract(contracthash1, { from: contractRegistry2 })
        .catch(function (error) {
          assert.isOk(error, "Expected error has not been caught");
        });
    });
    ...
    it("will delete a contract from the registry", function () {
      registry
        .submitContract(contracthash2, { from: contractRegistry1 })
        .then(function (response) {
          assert.isOk(response, "Contract submitting failed");
        });
    ...
    it("will verify a contract is not valid and will throw an error", function () {
      ...
      return registry.isValidContract(contracthash2).catch(function (error) {
        assert.isOk(error, "Expected error has not been caught");
      });
    });
