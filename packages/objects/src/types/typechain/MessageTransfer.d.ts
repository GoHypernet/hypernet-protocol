...
export class MessageTransfer extends Contract {
  ...
  create(arg0: BytesLike, arg1: BytesLike, overrides?: CallOverrides): Promise<boolean>;

  "create(bytes,bytes)"(arg0: BytesLike, arg1: BytesLike, overrides?: CallOverrides): Promise<boolean>;
  ...
  estimateGas: {
    ...
    create(arg0: BytesLike, arg1: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;

    "create(bytes,bytes)"(arg0: BytesLike, arg1: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    create(arg0: BytesLike, arg1: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "create(bytes,bytes)"(arg0: BytesLike, arg1: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
