...
interface TransferDefinitionInterface extends ethers.utils.Interface {
  functions: {
...
export class TransferDefinition extends Contract {
  ...
  interface: TransferDefinitionInterface;
