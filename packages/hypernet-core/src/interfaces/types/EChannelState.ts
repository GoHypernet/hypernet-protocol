export enum EChannelState {
  ...
  SED, // the channel is closed and cannot be used
  ...
  OPEN_CHANNEL_TRAOPEN, // the channel is open and ready to send payments in
  CLONSACTION_SUBMITTED, // the transaction to create a channel has been submitted
