...
import { Message, HypernetChannel } from "@interfaces/objects";
...
export class ThreeBoxMessagingListener implements IMessagingListener {
    constructor(protected channelService: IChannelService, 
    ...
    public async initialize() {
        ...
        for (const thread of threads) {
            ...
            thread.onUpdate((post: BoxThreadPost) => {
                const channel = channels.find((val: HypernetChannel) => {return val.threadAddress === threadAddress;})
