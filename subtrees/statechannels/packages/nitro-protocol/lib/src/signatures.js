...
function signStates(states, wallets, whoSignedWhat) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            stateHashes = states.map(function (s) { return state_1.hashState(s); });
            promises = wallets.map(function (w, i) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, sign(w, stateHashes[whoSignedWhat[i]])];
